...
\code{coupling = imex} under \code{imex2+} is the other stiff-safe choice. Second, the
optional radial pressure gradient: the constant acceleration on the gas of the NSH
