...
\author{\code{athenak-multigrid} tree, branches \code{dust-multigrid} and \code{dust-smr}\\
        ...
        \code{386d5968}; Phase 5 on \code{dust-smr} (uncommitted)}
...
\item \textbf{Refinement (Phase 5).} \textbf{Done} for static refinement,
      ...
      level of dust refinement, the coupled drag solvers under refinement, the
      gravity path on refined meshes (wired, untested), and particle splitting on entry
...
\item \textbf{Upstream defect.} \code{Particles::dtnew} was never assigned by the
