...
\title{Dust Particles and Gas$+$Dust Self-Gravity\\
       ...
       timestep under shear; Phase 4c: dust self-gravity}
...
each periodic direction, and 3D dust runs with TSC deposits develop a numerical
instability once $c_s\Delta t/\Delta z \gtrsim 0.35$.
...
\item \textbf{Dust self-gravity (4c).} \textbf{Done}, \S\ref{sec:phase4c}, both
      solvers. Open from it: the TSC drag-coupling instability at
      $c_s\Delta t/\Delta z \gtrsim 0.35$ (understand, then lift the \code{cfl} rule).
