...
\title{Dust Particles and Gas$+$Dust Self-Gravity\\
       ...
       and the Shear-Periodic Deposit Fold (Phase 4b, i)}
...
and shown to matter at the percent level on structured states. Still open in 4b:
back-reaction with an ideal-gas energy equation (required for cooling) and a particle
timestep that does not pay the full-shear-velocity penalty in wide boxes; their tests
are the momentum--energy budget of a drag-coupled ideal gas and the NSH state under
the relaxed step.
