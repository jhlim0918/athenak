...
\caption{The solver cross-check at $t=14$: FFT and multigrid agree on fate
and clock while the collapse is resolved, and part ways only beyond the
Truelove ceiling (dashed) --- neither number is physical there.}
\end{figure}

\section*{Status and next steps}
\textbf{Delivered}: FFT solver (validated, 3.5$\times$ faster than multigrid on
uniform grids, and now a full nonlinear cross-check twin); shearing-box
refinement infrastructure incl.\ AMR; multigrid gravity on uniform, SMR-ring,
boundary-annuli, and adaptive meshes, serial and MPI; $\sim$30 pages of validation documentation, a 44-cell reproducing
